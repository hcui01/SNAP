...
public class TreeExp implements Serializable{
	...
	*/
	...
	public TreeExp L_TIME(TreeExp another) throws EvalException{
		return (TreeExp)RDDL.ComputeArithmeticResult(this, another, "*");
	}
	
	public TreeExp L_ADD(TreeExp another) throws EvalException{
		return (TreeExp)RDDL.ComputeArithmeticResult(this, another, "+");
	}
	
	public TreeExp L_DEDUCT(TreeExp another) throws EvalException{
		return (TreeExp)RDDL.ComputeArithmeticResult(this, another, "-");
	}
	
	public TreeExp L_DIV(TreeExp another) throws EvalException{
		return (TreeExp)RDDL.ComputeArithmeticResult(this, another, "/");
	}
	
	public TreeExp L_NOT() throws EvalException{
		return (TreeExp)RDDL.ComputeArithmeticResult(TreeExp.BuildNewTreeExp(1.0, null), this, "-");
	}
