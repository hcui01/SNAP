...
public class Y_N_STA extends Policy {
	
	public Y_N_STA () {
		super();
	}
	
	public Y_N_STA(String instance_name) {
		super(instance_name);
		Global.ifLift = true;
...
public ArrayList<PVAR_INST_DEF> getActions(State s) throws EvalException {
		...
		r.fileAppend(algoName + "_" + (timeAllowed / 1000) + "_" + instanceName + "_sizeCounter", String.valueOf(F.counter));
		
		
		ArrayList<PVAR_INST_DEF> act = null;
		try {
			act = EmergencyReturn(s);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
