...
public abstract class Policy {
	...
	static public int maxnumConformantG = 0;
	...
	static public double countObs = 0;
	static public int countObsVars = 0;
	...
	public ArrayList<Integer> realConformantDepth = new ArrayList<>();
	
	public int actionCounter = 0;
	
	public double avgConformantDepth  = 0;
	...
	public TEState belief = new TEState();
	public boolean ifInitialBelief = false;
	public ArrayList<PVAR_INST_DEF> lastAction = null;
	
	// number of observations sampled.
	// if -1 generates all 
	static public int numObsGenerated = 10; 
	
	public int skipCounter = 0;
	
	public HashMap<PVAR_NAME, PVAR_NAME> obs2State = new HashMap<>();
	
	boolean ifDetectTrueObs = true;
	
	//max number of observations searched
	//if set to -1, means all
	static public int maxNumObs = -1;
